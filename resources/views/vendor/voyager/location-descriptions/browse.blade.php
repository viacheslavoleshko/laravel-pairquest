...
@section('page_header')
    ...
    <div class="container-fluid" style="display: flex">
        ...
        <div style="width: 15%;margin-top: auto;margin-bottom: auto;">
            <form action="{{ route('location-descriptions-import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <a class="btn btn-success" href="{{ route('location-descriptions-export') }}"><i class="voyager-download"></i> <span>Export data</span></a>
            </form>
        </div>
    </div>
@stop
