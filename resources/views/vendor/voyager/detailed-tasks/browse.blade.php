...
@section('page_header')
    ...
    <div class="container-fluid" style="display: flex">
        ...
        <div style="width: 15%;margin-top: auto;margin-bottom: auto;">
            <form action="{{ route('detailed-tasks-import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <a class="btn btn-success" href="{{ route('detailed-tasks-export') }}"><i class="voyager-download"></i> <span>Export data</span></a>
            </form>
        </div>
    </div>
@stop
